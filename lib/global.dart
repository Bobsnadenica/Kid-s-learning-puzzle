...
class Global {
  ...
  static List<GameCategory> get categories => [
    ...
    GameCategory(
      ...
      backgroundImage: "assets/backgrounds/space.jpg",
      items: space,
      previewEmoji: "🚀",
    ...
    GameCategory(
      ...
      backgroundImage: "assets/backgrounds/clothing.jpg",
      items: clothing,
      previewEmoji: "👗",
      accentColor: const Color(0xFFE91E63),
    ),
    GameCategory(
      ...
      backgroundImage: "assets/backgrounds/food.jpg",
      items: food,
      previewEmoji: "🍕",
    ...
    GameCategory(
      ...
      backgroundImage: "assets/backgrounds/instruments.jpg",
      items: instruments,
      previewEmoji: "🎸",
    ...
    GameCategory(
      ...
      backgroundImage: "assets/backgrounds/numbers.jpg",
      items: numbers,
      previewEmoji: "1️⃣",
    ...
    GameCategory(
      ...
      backgroundImage: "assets/backgrounds/emotions.jpg",
      items: emotions,
      previewEmoji: "😀",
      accentColor: const Color(0xFFE91E63),
    ),
    GameCategory(
      ...
      backgroundImage: "assets/backgrounds/insects.jpg",
      items: insects,
      previewEmoji: "🦋",
